  ...
  return (
    <div id="projects" className="py-20">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
        {projects.map((item) => (
          <div
            className="lg:min-h-[32.5rem] h-fit flex flex-col gap-16 items-center justify-center sm:w-96 w-[80vw]"
            key={item.id}
          >
            <Link href={item.link} className="w-fit">
              <PinContainer title={item.title} href={item.link}>
                <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] max-h-[200px] lg:h-[30vh] mb-10">
                  <div
